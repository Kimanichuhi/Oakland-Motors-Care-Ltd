      ...
      <div className="modal" style={{ width: 'min(940px, 100%)' }} onClick={(e) => e.stopPropagation()}>
        ...
        {!planned && !parsing && (
          <div className="modal-form">
            <p className="muted" style={{ margin: 0 }}>Upload a batch of historical work orders. Each row checks for an existing customer/vehicle and creates them automatically if missing (blank customer names all share one &quot;Walk-in customer&quot; record). Job numbers are generated by the app itself, in the same sequence live work orders use — the file&apos;s own Job Card No. column is for your reference only and isn&apos;t stored. Job Status maps to this app&apos;s statuses (Completed, In Progress, On Hold match directly; Pending → Open). Total Charge is recorded as a flat other-charge with no itemised labour/parts.</p>
